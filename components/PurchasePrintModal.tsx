        ...
        <div className="p-6 overflow-y-auto flex-1 bg-gray-950/50 p-6 flex justify-center">
          <div id="purchase-invoice-content" className="bg-white text-black p-6 w-[80mm] shadow-2xl h-fit">
            <div className="text-center mb-5 border-b-2 border-black pb-3">
              ...
              <div className="flex justify-between items-center mt-3 text-[10px] font-black border border-black p-2">
                  <span>التاريخ: {invoice.date}</span>
                  <span>#{invoice.id.slice(-4)}</span>
              </div>
              <div className="mt-2 text-center bg-gray-100 p-2">
            ...
            <table className="w-full mb-5 text-right border-collapse">
               <thead>
            ...
            <div className="mt-8 text-center text-[9px] font-black border-t border-dashed border-black pt-3">
